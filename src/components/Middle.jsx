      ...
      >
        <div className="flex flex-col sm:flex-row justify-center w-full p-4 sm:p-6 lg:p-9 items-center gap-4">
          ...
          >
            ...
            <button className="absolute right-3 text-3xl" type="submit">
              <TbCloudSearch />
            </button>
          </form>
          ...
          <>
            <div className="flex justify-center my-5">
              <div className="flex items-center gap-4">
                <div className="text-7xl">
                  {weatherData.currentTemp}°{isCelsius ? "C" : "F"}
                </div>
                ...
                <button
                  ...
                  className="
																					...
																					"
                >
                  {isCelsius ? <RiFahrenheitFill /> : <RiCelsiusFill />}
                </button>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex gap-5">
                <span>
                  Min: {weatherData.minTemp}°{isCelsius ? "C" : "F"}
                </span>
                <span>
                  Max: {weatherData.maxTemp}°{isCelsius ? "C" : "F"}
                </span>
              </div>
            </div>
          </>
